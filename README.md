...
veintisiete **páginas web interactivas**, una por tema del manual. Todo es material original de práctica; **no incluye
...
| `04_Simuladores_web/` | **27 páginas interactivas**, el curso completo: **Grammar 1–14** y **Structure 1–13**. Gramática: condicionales, wish / would rather, conectores condicionales, voz pasiva, modales de deducción en pasado, verbo + objeto + infinitivo, reported speech, relative clauses, noun clauses, future forms, gerundio tras preposición, future passive, future in the past y future progressive. Vocabulario y formación de palabras: colocaciones de adverbio + adjetivo, palabras científicas, adjetivos compuestos, lenguaje de viaje y marketing, phrasal verbs de viaje y de tareas, verbos de tres piezas, sufijos que forman verbos, noun modifiers, ropa y tendencias, cómo se forman las palabras nuevas, metas y motivación, y prefijos. | Descarga el `.html` y ábrelo con doble clic: funciona **sin internet**, en computadora o celular. Tres modos: *Explore* (ver la regla en acción) → *Build* (armar oraciones) → *Drill* (práctica graduada con marcador). |

## Episodios de *In the Lab FM*

| Episodio | Unidad | Título (tema) | Duración | Archivo |
|---|---|---|---|---|
| E1 | Unit 6 | *The Magnet in Your Kitchen Door* (magnetismo) | 5:02 | `E1_U6_magnetism_tts.m4a` |
| E2 | Unit 7 | *Congratulations, You Helped Ruin a Small Town* (sobreturismo) | 5:03 | `E2_U7_overtourism_tts.m4a` |
| E3 | Unit 8 | *The Man Who Noticed the Door* (futuro del trabajo) | 4:48 | `E3_U8_future_work_tts.m4a` |
| E4 | Unit 9 | *Word Detectives* (palabras nuevas y moda) | 5:20 | `E4_U9_words_fashion_tts.m4a` |
| E5 | Unit 10 | *One Now or Two Later* (procrastinación) | 4:44 | `E5_U10_procrastination_tts.m4a` |
| E6 | Grammar 3 · Structure 2 | *The Vault at the End of the World* (conjunciones condicionales y formación de palabras) | 5:09 | `E6_G3-S2_seed_vault_tts.m4a` |

## Reglas de oro del formato SELLI

1. Lee las opciones antes de que empiece el audio y anticipa la pregunta.
2. La opción correcta casi siempre **parafrasea** lo que oíste; las incorrectas repiten palabras del audio.
3. Un negativo o un *idiom* puede voltear todo el sentido: eso es lo que evalúan.
4. No hay penalización por error: **nunca dejes un reactivo en blanco**.

---

© 2026 Prof. Daniel Lara (profe.daniellara). Material original para uso educativo.
Si lo compartes, conserva la atribución.
