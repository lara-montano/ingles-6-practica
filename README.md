...
cinco **simuladores web** de gramática. Todo es material original de práctica; **no incluye
...
| `04_Simuladores_web/` | **5 simuladores interactivos** de gramática: condicionales, conectores condicionales, voz pasiva, modales de deducción en pasado y reported speech. | Descarga el `.html` y ábrelo con doble clic: funciona **sin internet**, en computadora o celular. Tres modos: *Explore* (ver la regla en acción) → *Build* (armar oraciones) → *Drill* (práctica graduada con marcador). |
