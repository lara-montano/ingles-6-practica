...
<header>
  ...
  <div class="wrap">
    ...
    <p class="sub">Una página interactiva por cada tema del manual, de gramática y de vocabulario, más el simulacro tipo SELLI, el SELLI Gym de listening y el Listening Lab con los episodios de <i>In the Lab FM</i>. Todo se abre desde aquí y los audios se reproducen sin descargar.</p>
    <div class="chipline">
